...
version control is a system that tracks changes to files overtime , allowing multiple user's to collaborate efficiently while maintaining a history of modifications . it ensures previous versions of projects can be ass
